...
export default function CatText(){
    ...
    return(
        <div>
           ...
           <p> 
           The app uses <i>useContext</i> and <i>useReducer</i> - the React Hooks for creating globalContext and keeping and using the state of the ADD and REMOVE in the Cart. Axios is used as the HTTP-client.
           </p>
